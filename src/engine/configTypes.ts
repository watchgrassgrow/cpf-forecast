...
export interface CpfRulesConfig {
  ...
  /**
   * The CPF Annual Limit: the maximum total of MANDATORY + VOLUNTARY CPF
   * contributions a member's accounts can receive across all 3 accounts
   * in one calendar year. Published directly by CPF Board as a single
   * figure (not derived from the OW/AW ceilings). Currently $37,740 for
   * 2026. Voluntary-3-account top-up headroom for a given year = this
   * limit minus mandatory contributions already received that year.
   */
