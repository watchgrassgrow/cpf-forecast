...
// The CPF Annual Limit: the total of MANDATORY + VOLUNTARY CPF contributions
// (to all 3 accounts) a member's accounts can receive in one calendar year.
// This is a DIFFERENT figure from the AW ceiling base above - it directly
// caps voluntary-3-account top-ups (the amount a member can still
// voluntarily contribute = this limit minus mandatory contributions
// already received that year). Published directly by CPF Board (not a
// derived formula). Source: "What is the CPF Annual Limit?", CPF Board.
const CPF_ANNUAL_LIMIT = 37740;
...
export const CPF_RULES_2026: CpfRulesConfig = {
  ...
  cpfAnnualLimit: CPF_ANNUAL_LIMIT,
