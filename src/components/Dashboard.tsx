  ...
  return (
    <div className={styles.dashboard}>
      ...
      <p className={styles.estimateNote}>
        ...
        published contribution, allocation, and interest rates — these are exact, not estimates.
        <strong> CPF LIFE payout</strong> figures are approximations calibrated against CPF Board's
        published examples (the exact payout formula isn't publicly disclosed) — for your real
        payout, use CPF Board's{' '}
        <a href="https://www.cpf.gov.sg/member/tools-and-services/calculators/monthly-payout-estimator" target="_blank" rel="noopener noreferrer">
          Monthly Payout Estimator
        </a>{' '}
        (age 55+, requires login) once you have an actual RA balance.
      </p>
      ...
      <div className={styles.tabBody}>
        ...
        {activeTab === 'events' && (
          <LifeEventsTab form={form} summary={summary} />
        )}
        {activeTab === 'table' && (
